...
Our hosts at KRIHS kindly put together a full programme detailing the activities that occured during the two days of research presentations. This programme contains a detailed list of speakers (and presentations).

The full programme can be viewed [here](KRIHS-GDSL-Programme.pdf)
...
Slides for these talks can be found [here](https://github.com/patrickballantyne/GDSL-KRIHS-Exchange/tree/main/slides). 
